...
syntax match fishOption / -[[:alnum:]-=]\+/
syntax match fishRedirection /\(0\|1\|2\|&\)\?\(>\|<\)\([[:alnum:]\/._-]\+\|&0\|&1\|&2\)/
syntax match fishRedirection /\(|\|;\|&\)/

syntax region fishLineContinuation matchgroup=fishStatement
            \ start='\v^\s*\zs\k+>' skip='\\$' end='$'
            \ contains=fishOption,fishSpecial,fishIdentifier,fishString,fishCharacter,fishStatement,fishCommandSub,fishComment,fishRedirection
