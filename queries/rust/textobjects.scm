;; functions
(function_signature_item) @function.outer @function.around
(function_item) @function.outer @function.around
(function_item
  body: (block . "{" . (_) @_start @_end (_)? @_end . "}"
  (#make-range! "function.inner" @_start @_end)))

;; quantifies as class(es)
(struct_item) @class.outer @class.around
(struct_item
  body: (field_declaration_list . "{" . (_) @_start [(_)","]? @_end . "}"
  (#make-range! "class.inner" @_start @_end)))

(enum_item) @class.outer @class.around
(enum_item
  body: (enum_variant_list . "{" . (_) @_start [(_)","]? @_end . "}"
  (#make-range! "class.inner" @_start @_end)))

(union_item) @class.outer @class.around
(union_item
  body: (field_declaration_list . "{" . (_) @_start [(_)","]? @_end . "}"
  (#make-range! "class.inner" @_start @_end)))

(trait_item) @class.outer @class.around
(trait_item
  body: (declaration_list . "{" . (_) @_start @_end (_)? @_end . "}"
  (#make-range! "class.inner" @_start @_end)))

(impl_item) @impl.outer @impl.around
(impl_item
  body: (declaration_list . "{" . (_) @_start @_end (_)? @_end . "}"
  (#make-range! "class.inner" @_start @_end)))
...
(block_comment) @comment.outer @comment.around
(doc_comment_block) @comment.outer @comment.around
